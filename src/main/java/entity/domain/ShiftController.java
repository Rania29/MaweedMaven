...
public class ShiftController implements Serializable {
    ...
    @EJB
    private facade.ShiftFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Shift) getItems().getRowData();
    ...
    public Shift getShift(java.lang.Long id) {
